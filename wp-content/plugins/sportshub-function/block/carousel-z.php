...
class sportshub_carousel_z extends Widget_Base {
    public $base;
    public function get_name() {
        return 'sportshub-carousel-z';
    }
    public function get_title() {
        return esc_html__( 'Carousel Z', 'sportshub' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
             'themelazer_offset_item_num',
             [
             'label'         => esc_html__( 'Skip post count', 'sportshub' ),
             'type'          => Controls_Manager::NUMBER,
             'default'       => '0',
             'condition' => [ 'themelazer_offset_enable' => 'yes' ]
    ...
    protected function render( ) { 
        ...
        if($settings['themelazer_offset_enable']=='yes') {
            $arg['offset'] = $settings['themelazer_offset_item_num'];
        }
        ...
        <?php if ( $query->have_posts() ) : 
            ...
            <div class="themelazer_perosnal_blog_slider_wrapper  ">
                <div class="themelazer-carousel-z " data-arrows="true" data-play="true" data-loop="true" data-dots="false" data-swipe="true" data-items="4" data-xs-items="1" data-sm-itemss="1" data-md-items="2" data-lg-items="4" data-xl-items="4"> 
                    <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                        <div class="themelazer-carousel-item">
                            <div class="themelazer_perosnal_blog_slider_content carousel-z">
                                ...
                                <div class="car_text_box">
                                    ...
                                    <h3><a href="<?php the_permalink(); ?>" tabindex="-1" title="<?php the_title();?>"><?php the_title()?></a></h3>                        
