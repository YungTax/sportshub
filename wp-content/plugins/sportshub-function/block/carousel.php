...
class sportshub_carousel extends Widget_Base {

    public $base;
    public function get_name() {
        return 'sportshub-carousel';
    }
    public function get_title() {
        return esc_html__( 'Carousel', 'sportshub' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'post_carousel_layout',
            [
                'label'     =>esc_html__( 'Carousel post Layout', 'sportshub' ),
                'description' =>esc_html__( 'Select Post Layout per page.', 'sportshub'),
                'type'      =>Controls_Manager::SELECT,
                'default'   => 'carousel_layout1',
                'options'   => [
                        'carousel_layout1'    =>esc_html__( 'Carousel Layout 1', 'sportshub' ),
                        'carousel_layout2'    =>esc_html__( 'Carousel Layout 2', 'sportshub' ),
                        'carousel_layout3'    =>esc_html__( 'Carousel Layout 3', 'sportshub' ),
                        'carousel_layout4'    =>esc_html__( 'Carousel Layout 4', 'sportshub' ),
                        'carousel_layout5'    =>esc_html__( 'Carousel Layout 5', 'sportshub' ),
                        'carousel_layout6'    =>esc_html__( 'Carousel Layout 6', 'sportshub' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'sportshub'),
                'label_off' => esc_html__('Hide', 'sportshub'),
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
             'ts_offset_item_num',
             [
             'label'         => esc_html__( 'Skip post count', 'sportshub' ),
             'type'          => Controls_Manager::NUMBER,
             'default'       => '0',
    ...
    protected function render( ) { 
        ...
        $post_carousel_layout =$settings['post_carousel_layout'];
    ...
    <?php if($post_carousel_layout == 'carousel_layout1'){?>
        <div class="themelazer_perosnal_blog_slider_wrapper  ">
            <div class="themelazer-carousel themelazer_loading_before_slick_initialized" data-arrows="true" data-play="true" data-loop="true" data-dots="false" data-swipe="true" data-items="3" data-xs-items="1" data-sm-itemss="1" data-md-items="2" data-lg-items="3" data-xl-items="3">
          <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                <div class="themelazer-carousel-item">
                    <div class="themelazer_perosnal_blog_slider_content carousel">
                    <?php $feature_img_main = get_post_thumbnail_id();
                    $feature_img_main_bg = wp_get_attachment_image_src( $feature_img_main, 'sportshub_carousel', true );
                    if($feature_img_main){?>
                    <div class="themelazer_item_img" style="background-image: url('<?php echo esc_url($feature_img_main_bg[0]); ?>')"></div>
                    <?php }else{echo '<div class="themelazer_item_link"></div>';}?>
                    ...
                    <div class="car_text_box">
                       ...
                       if(get_theme_mod('disable_post_date') !=1 && $show_date =='yes'){ echo '<li class="post-date">'.get_the_date().'</li>';}
        ...
        <?php }elseif($post_carousel_layout == 'carousel_layout2'){?>               
            <div class="themelazer_perosnal_blog_slider_wrapper  ">
            <div class="themelazer-carousel themelazer_loading_before_slick_initialized" data-arrows="true" data-play="true" data-loop="true" data-dots="false" data-swipe="true" data-items="3" data-xs-items="1" data-sm-itemss="1" data-md-items="2" data-lg-items="3" data-xl-items="3">
          <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                <div class="themelazer-carousel-item">
            ...
            <?php }elseif($post_carousel_layout == 'carousel_layout3'){?>               
                <div class="themelazer_perosnal_blog_slider_wrapper  ">
                    <div class="themelazer-carousel themelazer_loading_before_slick_initialized" data-arrows="true" data-play="true" data-loop="true" data-dots="false" data-swipe="true" data-items="3" data-xs-items="1" data-sm-items="1" data-md-items="2" data-lg-items="3" data-xl-items="3">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <div class="themelazer-carousel-item">
                                <div class="themelazer_perosnal_blog_slider_content carousel">
                                    <?php $feature_img_main = get_post_thumbnail_id();
                                        $feature_img_main_bg = wp_get_attachment_image_src( $feature_img_main, 'sportshub_carousel', true );
                                        if($feature_img_main){?>
                                    <div class="themelazer_item_img layout3" style="background-image: url('<?php echo esc_url($feature_img_main_bg[0]); ?>')"></div>
                                    <?php }else{echo '<div class="themelazer_item_link"></div>';}?>
                                    <?php
                                        $categories = get_the_category(get_the_ID());          
                                            if ($categories) {
            ...
            <?php }elseif($post_carousel_layout == 'carousel_layout4'){?>               
                <div class="themelazer_perosnal_blog_slider_wrapper  ">
                    <div class="themelazer-carousel themelazer_loading_before_slick_initialized" data-arrows="true" data-play="true" data-loop="true" data-dots="false" data-swipe="true" data-items="3" data-xs-items="1" data-sm-itemss="1" data-md-items="2" data-lg-items="3" data-xl-items="3">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <div class="themelazer-carousel-item layout4 ">
                                <div class="themelazer_perosnal_blog_slider_content carousel">
                                    <?php $feature_img_main = get_post_thumbnail_id();
                                        $feature_img_main_bg = wp_get_attachment_image_src( $feature_img_main, 'sportshub_carousel', true );
                                        if($feature_img_main){?>
            ...
            <?php }elseif($post_carousel_layout == 'carousel_layout5'){?>               
                <div class="themelazer_perosnal_blog_slider_wrapper  ">
                    <div class="themelazer-carousel themelazer_loading_before_slick_initialized" data-arrows="true" data-play="true" data-loop="true" data-dots="false" data-swipe="true" data-items="3" data-xs-items="1" data-sm-itemss="1" data-md-items="2" data-lg-items="3" data-xl-items="3">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <div class="themelazer-carousel-item layout5">
                                <div class="themelazer_perosnal_blog_slider_content carousel">
                                    <?php $feature_img_main = get_post_thumbnail_id();
                                        $feature_img_main_bg = wp_get_attachment_image_src( $feature_img_main, 'sportshub_carousel', true );
                                        if($feature_img_main){?>
