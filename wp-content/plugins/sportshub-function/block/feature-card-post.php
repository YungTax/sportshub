...
class sportshub_feature_card_post extends Widget_Base {

    public $base;
    public function get_name() {
        return 'sportshub-feature-card-post';
    }
    public function get_title() {
        return esc_html__( 'Feature Card Post', 'sportshub' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'feature_card_post_layout',
            [
                'label'     =>esc_html__( 'Feature Card Post Layout', 'sportshub' ),
                'description' =>esc_html__( 'Select Post Layout per page.', 'sportshub'),
                'type'      =>Controls_Manager::SELECT,
                'default'   => 'feature_post_layout1',
                'options'   => [
                        'feature_post_layout1'    =>esc_html__( 'Layout 1', 'sportshub' ),
                        'feature_post_layout2'    =>esc_html__( 'Layout 2', 'sportshub' ),
                        'feature_post_layout3'    =>esc_html__( 'Layout 3', 'sportshub' ),
                        'feature_post_layout4'    =>esc_html__( 'Layout 4', 'sportshub' ),
                        'feature_post_layout5'    =>esc_html__( 'Layout 5', 'sportshub' ),
                        'feature_post_layout6'    =>esc_html__( 'Layout 6', 'sportshub' ),
                        'feature_post_layout7'    =>esc_html__( 'Layout 7', 'sportshub' ),
                        'feature_post_layout8'    =>esc_html__( 'Layout 8', 'sportshub' ),
                        'feature_post_layout9'    =>esc_html__( 'Layout 9', 'sportshub' ),
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'DESC',
                'options'   => [
                        'DESC'      =>esc_html__( 'Descending', 'sportshub' ),
                        'ASC'       =>esc_html__( 'Ascending', 'sportshub' ),
                    ],
            ]
        );
    ...
    protected function render( ) { 
        ...
        $feature_card_post_layout = $settings['feature_card_post_layout'];
        ...
        <?php if ( $query->have_posts() ) : 
            if($section_title !=''){
                ...
                <?php if($feature_card_post_layout == 'feature_post_layout1'){?>
                    <div class="themelazer_feature_card_Post_wrapper">
                                ...
                                <a href="<?php the_permalink(); ?>">
                                    <div class="card_post_out" <?php  echo 'style="background:'.$title_bg_Color.';"' ?>>
                                        ...
                                        <div class="content_wrapper">                    
                                            ...
                                            <p class="post_tag"><?php the_tags('', '', ''); ?> </p>
                                        </div>
                                    </div>
                                </a>  
                            </div>
                ...
                <?php }elseif($feature_card_post_layout == 'feature_post_layout2'){?>  
                    <div class="themelazer_feature_card_Post_wrapper">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <?php 
                                $categories = get_the_category(get_the_ID());          
                            ...
                            <div class="thememlazer_feature_card_post">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="card_post_out" <?php  echo 'style="background:'.$title_bg_Color.';"' ?>>
                                        ...
                                        <?php  if($show_thumbnail=='yes'){ 
                                            echo ' <div class="post-thumbnail layout2 ">';
                                            if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);}
                                            echo ' </div>';
                                        } ?>  
                                         <p class="post_date"><?php echo get_the_date(); ?></p>
                    ...
                    <?php }elseif($feature_card_post_layout == 'feature_post_layout3'){?>  
                    <div class="themelazer_feature_card_Post_wrapper">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <?php 
                                $categories = get_the_category(get_the_ID());          
                            ...
                            <div class="thememlazer_feature_card_post">
                             <a href="<?php the_permalink(); ?>">
                                <div class="card_post_out" <?php  echo 'style="background:'.$title_bg_Color.';"' ?>>
                                    ...
                                    <?php  if($show_thumbnail=='yes'){ 
                                            echo ' <div class="post-thumbnail layout3 ">';
                                            if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);}
                                            echo ' </div>';
                                    } ?>  
                                     <p class="post_date"><?php echo get_the_date(); ?></p>
                    ...
                    <?php }elseif($feature_card_post_layout == 'feature_post_layout4'){?>  
                    <div class="themelazer_feature_card_Post_wrapper">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <?php 
                                $categories = get_the_category(get_the_ID());          
                            ...
                            <div class="thememlazer_feature_card_post">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="card_post_out" <?php  echo 'style="background:'.$title_bg_Color.';"' ?>>
                                        ...
                                        <?php  if($show_thumbnail=='yes'){ 
                                            echo ' <div class="post-thumbnail layout4 ">';
                                            if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);}
                                            echo ' </div>';
                                        } ?>
                    ...
                    <?php }elseif($feature_card_post_layout == 'feature_post_layout5'){?>  
                    <div class="themelazer_feature_card_Post_wrapper">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <?php 
                                $categories = get_the_category(get_the_ID());          
                            ...
                            <div class="thememlazer_feature_card_post">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="card_post_out" <?php  echo 'style="background:'.$title_bg_Color.';"' ?>>
                                        ...
                                        <?php  if($show_thumbnail=='yes'){ 
                                            echo ' <div class="post-thumbnail layout5 ">';
                                            if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);}
                                            echo ' </div>';
                                        } ?>
                                        <p class="post_date"><?php echo get_the_date(); ?></p>
                    ...
                    <?php }elseif($feature_card_post_layout == 'feature_post_layout6'){?>  
                    <div class="themelazer_feature_card_Post_wrapper">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <?php 
                                $categories = get_the_category(get_the_ID());          
                            ...
                            <div class="thememlazer_feature_card_post">
                                <a href="<?php the_permalink(); ?>">    
                                    <div class="card_post_out" <?php  echo 'style="background:'.$title_bg_Color.';"' ?>>
                                        ...
                                        <?php  if($show_thumbnail=='yes'){ 
                                            echo ' <div class="post-thumbnail layout6 ">';
                                            if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);}
                                            echo ' </div>';
                                        } ?>
                                        <p class="post_date"><?php echo get_the_date(); ?></p>
                    ...
                    <?php }elseif($feature_card_post_layout == 'feature_post_layout7'){?>  
                    <div class="themelazer_feature_card_Post_wrapper">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <?php 
                                $categories = get_the_category(get_the_ID());          
                            ...
                            <div class="thememlazer_feature_card_post">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="card_post_out" <?php  echo 'style="background:'.$title_bg_Color.';"' ?>>
                                        ...
                                        <?php  if($show_thumbnail=='yes'){ 
                                            echo ' <div class="post-thumbnail layout7 ">';
                                            if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);}
                                            echo ' </div>';
                                        } ?>
                                        <p class="post_date"><?php echo get_the_date(); ?></p>
                ...
                <?php }elseif($feature_card_post_layout == 'feature_post_layout8'){?>  
                    <div class="themelazer_feature_card_Post_wrapper">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <?php 
                                $categories = get_the_category(get_the_ID());          
                            ...
                            <div class="thememlazer_feature_card_post layout_eight ">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="card_post_out" <?php  echo 'style="background:'.$title_bg_Color.';"' ?>>
                                        ...
                                        <?php  if($show_thumbnail=='yes'){ 
                                            echo ' <div class="post-thumbnail layout8 ">';
                                            if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);}
                                            echo ' </div>';
                                        } ?>
                                        <p class="post_date"><?php echo get_the_date(); ?></p>
            ...
            <?php }elseif($feature_card_post_layout == 'feature_post_layout9'){?>  
                    <div class="themelazer_feature_card_Post_wrapper">
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <?php 
                                $categories = get_the_category(get_the_ID());          
                            ...
                            <div class="thememlazer_feature_card_post layout_night ">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="card_post_out" <?php  echo 'style="background:'.$title_bg_Color.';"' ?>>
                                        ...
                                        <?php  if($show_thumbnail=='yes'){ 
                                            echo ' <div class="post-thumbnail layout9 ">';
                                            if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);}
                                            echo ' </div>';
                                        } ?>
                                        <p class="post_date"><?php echo get_the_date(); ?></p>
