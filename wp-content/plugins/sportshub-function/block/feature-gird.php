...
class sportshub_feature_grid extends Widget_Base {

    public $base;
    public function get_name() {
        return 'sportshub-feature-grid';
    }
    public function get_title() {
        return esc_html__( 'Feature Grid Post', 'sportshub' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'smaall_list_post_layout',
            [
                'label'     =>esc_html__( 'Small List Post Layout', 'sportshub' ),
                'description' =>esc_html__( 'Select Post Layout per page.', 'sportshub'),
                'type'      =>Controls_Manager::SELECT,
                'default'   => 'small_list_layout1',
                'options'   => [
                        'small_list_layout1'    =>esc_html__( 'Small List Layout 1', 'sportshub' ),
                        'small_list_layout2'    =>esc_html__( 'Small List Layout 2', 'sportshub' ),
                ],
            ]
        );
        $this->add_control(
    ...
    protected function render( ) { 
        ...
        $smaall_list_post_layout    = $settings['smaall_list_post_layout'];
        ...
        <?php if ( $query->have_posts() ) : 
            if($section_title !=''){
                ...
                <?php if($smaall_list_post_layout == 'small_list_layout1'){?>

                    <div class="themelazer_top_list_wrapper">
                                    ...
                                    <div class="post-thumbnail">
                                        <?php if (has_post_thumbnail()) : ?>
                                            <a href="<?php the_permalink(); ?>">
                                                <?php the_post_thumbnail('large'); // Using larger image size for the first post ?>
                                            </a>
                                        <?php endif; ?>
                                    </div>
                                    <div class="post-inner">
                                        <div class="entry-header">
                                                ...
                                                if ($categories) : ?>
                                                    <div class="themelazer_post_categories">
                                                        <?php foreach ($categories as $tag) :
                                                            ...
                                                            <a class="post-category-color-text" itemprop="articleSection" style="background: <?php echo esc_attr($title_bg_Color); ?>!important" href="<?php echo esc_url($tag_link); ?>">
                                            ...
                                            <h2 class="entry-title">
                                                <a href="<?php the_permalink(); ?>" title="<?php echo esc_attr(get_the_title()); ?>" tabindex="-1">
                                                    <?php the_title(); ?>
                                                </a>
                                            </h2>
                                        </div>
                            ...
                            <?php else : ?>
                                <div class="themelazer_article_list">
                                    <div class="post-outer">
                                        <div class="post-inner">
                                            <div class="post-thumbnail layout-two">
                                                <?php if ( has_post_thumbnail()) {the_post_thumbnail('sportshub_small_feature');} ?> <a href="<?php the_permalink(); ?>"></a>
                                            </div>
                                        </div>
                                        <div class="post-inner">
                                            <div class="entry-header">                    
                                                ...
                                                <h2 class="entry-title"><a href="<?php the_permalink(); ?>"title="<?php get_the_title();?>" tabindex="-1"><?php the_title()?></a></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <?php }elseif($smaall_list_post_layout == 'small_list_layout2'){?>  
                    <div class="themelazer_top_list_wrapper">
                        <div class="themelazer_top_list_in">
                            <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                                <div class="themelazer_article_list">
