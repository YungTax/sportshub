...
class sportshub_feature_link_list_post extends Widget_Base {
    public $base;
    public function get_name() {
        return 'sportshub-feature-link-list-post';
    }
    public function get_title() {
        return esc_html__( 'Featue Link List Post', 'sportshub' );
    }
    ...
    protected function render( ) { 
        ...
        <?php if ( $query->have_posts() ) : 
            ...
            <div class="themelazer_feature_link_list">
