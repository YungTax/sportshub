...
class sportshub_feature_link_marquee_post extends Widget_Base {
    public $base;
    public function get_name() {
        return 'sportshub-feature-link-marquee-post';
    }
    public function get_title() {
        return esc_html__( 'Featue Link Marquee Post', 'sportshub' );
    }
