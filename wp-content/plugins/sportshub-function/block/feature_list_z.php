...
class sportshub_feature_list_z extends Widget_Base {

    public $base;
    public function get_name() {
        return 'sportshub-feature-list';
    }
    public function get_title() {
        return esc_html__( 'Feature List Z Post', 'sportshub' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::SELECT,
                'default'   => 'sportshub_large_list_feature',
                'options'   => [
                        ...
                        'sportshub_large_list_feature' =>esc_html__( 'sportshub Large List Feature'),
    ...
    protected function render( ) { 
        ...
        if($post_grid_col =='grid_col1'){
          $post_col = "col-lg-12 col-md-12 col-sm-12";
        }elseif($post_grid_col =='grid_col2'){
          $post_col = "col-lg-6 col-md-6 col-sm-6";
        }elseif($post_grid_col =='grid_col3'){
          $post_col = "col-lg-4 col-md-4 col-sm-4";
        }elseif($post_grid_col =='grid_col4'){
          $post_col = "col-lg-3 col-md-3 col-sm-3";
        }elseif($post_grid_col =='grid_col5'){
           $post_col = "col-lg-2 col-md-4 col-sm-6";
        }   
                    ...
                    <?php if($post_grid_layout == 'grid_layout1'){?>
                         <div class="<?php echo esc_html($post_col); ?>">
                            <div class="blog-style-one">
                                <div class="single-blog-style-one thumb">
                                    <!-- <span class="themelazer_feature_list_count"><?php echo esc_html($i); ?></span> -->
                                    <div class="img-box feature_grid <?php if ( has_post_thumbnail()){echo 'ghave_img';}else{echo 'gnone_img';}?>">
                                        <a href="<?php the_permalink(); ?>">
                                        <?php  if($show_thumbnail=='yes'){ if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);}} ?></a>
                                    </div>                        
                                    <div class="text-box"<?php echo 'style="text-align:'.$blog_text_align.';'.'">'?>
                                        ...
                                        <?php echo '<'.$post_title_html_tag.'>'.'<a href="'.esc_url(get_the_permalink()).'" tabindex="-1" title="'.esc_attr(get_the_title()).'">'.esc_attr(get_the_title()).'</a>'.'</'.$post_title_html_tag.'>' ?>
