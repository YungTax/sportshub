...
class sportshub_large_list_post extends Widget_Base {

    public $base;
    public function get_name() {
        return 'sportshub-large-list-post';
    }
    public function get_title() {
        return esc_html__( 'Large List Post', 'sportshub' );
    }
                ...
                <div class="themelazer_article_list themelazer_article_list_l">
                    <div class="post-outer">
                        <div class="post-inner">
                            <div class="post-thumbnail redius">
