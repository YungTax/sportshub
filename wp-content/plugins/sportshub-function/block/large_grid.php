...
class sportshub_large_grid_post extends Widget_Base {
    public $base;
    public function get_name() {
        return 'sportshub-large-grid-post';
    }
    public function get_title() {
        return esc_html__( 'large Grid Post', 'sportshub' );
    }
    ...
    protected function render( ) { 
        ...
        <div class="row">          
            <?php if ( $query->have_posts() ) : ?>
                    ...
                    <div class="<?php echo esc_html($post_col); ?>">
                        <div class="themelazer_blog_style_one">
                            <div class="sigle_blog_style_one">
                                ...
                                <div class="themelazer_xl_grid_image_front <?php if ( has_post_thumbnail()){echo 'ghave_img';}else{echo 'gnone_img';}?>">
                                    <a href="<?php the_permalink(); ?>">
                                        <?php  if($show_thumbnail=='yes'){ if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);}} ?>
                                    </a>
                                </div>                 
                                <div class="text_box">         
                                    <p class="themelazer_post_entry">
                                        <?php if($show_contents=='yes'){ echo wp_trim_words( get_the_content(), $count_words, '...' );}?> 
                                    </p>
                                    <div class="themelazer_post_meta">
                                        <div class="themelazer_more_post_button">
                                            <div class="themelazer_read_more_style2_wrapper">                            
                                                <a class="themelazer_read_more" href="<?php the_permalink(); ?>">
                                                    <?php esc_html_e( 'continue reading ', 'sportshub' )?><i class="ti-arrow-right"></i>
                                                </a>                            
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="themelazer_social_sharebox">
                                            ...
                                            <?php if(get_theme_mod('disable_post_share') !=1){ 
                                                if(function_exists('sportshub_single_share_link')){
                                                    echo sportshub_single_share_link(get_the_ID());
                                            }}?>                            
                                        </div>
                                    </div>
                                </div>
                ...
                <?php endwhile;
                    if($settings['pagination_enable']=='yes') {
                        echo '<div class="themelazer-pagination"><div class="themelazer-pagination-wrapper">'. sportshub_pagination_num( array( 'paged' => $paged , 'total' => $query->max_num_pages ) ).'</div></div>';
                        wp_reset_postdata();
                    }
                ?>
            </div>                
