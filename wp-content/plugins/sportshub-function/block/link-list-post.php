...
class sportshub_link_list_post extends Widget_Base {
    public $base;
    public function get_name() {
        return 'sportshub-link-list-post';
    }
    public function get_title() {
        return esc_html__( 'Link List Post', 'sportshub' );
    }
    ...
    protected function render( ) { 
        ...
        <?php if ( $query->have_posts() ) : 
            ...
            <div class="themelazer_small_list">
                            ...
                            <div class="post-outer">
                                <div class="post-inner">
                                    <div class="post-thumbnail
                                        ...
                                        ?>
                                    ">
                                    <?php if ( has_post_thumbnail()) {the_post_thumbnail('sportshub_small_feature');} ?> 
