...
class sportshub_list_post extends Widget_Base {

    public $base;
    public function get_name() {
        return 'sportshub-list-post';
    }

    public function get_title() {
        return esc_html__( 'List Post', 'sportshub' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'post_list_layout',
            [
                'label'     =>esc_html__( 'List post Layout', 'sportshub' ),
                'description' =>esc_html__( 'Select Post Layout per page.', 'sportshub'),
                'type'      =>Controls_Manager::SELECT,
                'default'   => 'list_layout1',
                'options'   => [
                        'list_layout1'    =>esc_html__( 'List Layout 1', 'sportshub' ),
                        'list_layout2'    =>esc_html__( 'List Layout 2', 'sportshub' ),
                        'list_layout3'    =>esc_html__( 'List Layout 3', 'sportshub' ),
                        'list_layout4'    =>esc_html__( 'Lsit Layout 4', 'sportshub' ),
                        'list_layout5'    =>esc_html__( 'List Layout 5', 'sportshub' ),
                        'list_layout6'    =>esc_html__( 'List Layout 6', 'sportshub' ),
    ...
    protected function render( ) { 
        ...
        <?php if ( $query->have_posts() ) : ?>
            <?php $i = 0; while ( $query->have_posts() ) : $query->the_post(); $i++; ?>
                ...
                <?php }elseif($post_list_layout == 'list_layout2'){?>           
                    <div class="themelazer_article_list themelazer_article_list_l">
                        <div class="post-outer">
                            <div class="post-inner">
                                <div class="post-thumbnail-layout-2">
                                    <a href="<?php the_permalink(); ?>"></a><?php if( has_post_thumbnail()) {the_post_thumbnail($thumbnail_size);} ?>
                                </div>
                            </div>
                            <div class="post-inner">
