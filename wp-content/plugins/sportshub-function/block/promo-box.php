...
class sportshub_promo_box extends Widget_Base {
   public $base;
   public function get_name() {
      return 'sportshub-promo-box';
   }
   public function get_title() {
      return esc_html__( 'Promo Box', 'sportshub' );
   }
   ...
   protected function register_controls() {
      ...
      $this->start_controls_section(
         'section_tab',
         [
               'label' => esc_html__('Promo Box Section', 'sportshub'),
         ]
      );
      $this->add_control(
            'section_title', 
      ...
      $this->add_control(
         'promo_box_layout',
         [
               'label'     =>esc_html__( 'Promo Box Layout', 'sportshub' ),
               'description' =>esc_html__( 'Select Promo Box Layout', 'sportshub'),
               'type'      =>Controls_Manager::SELECT,
               'default'   => 'promo_box_layout1',
               'options'   => [
                     'promo_box_layout1'    =>esc_html__( 'Promo Box Layout 1', 'sportshub' ),
                     'promo_box_layout2'    =>esc_html__( 'Promo Box Layout 2', 'sportshub' ),
                     'promo_box_layout3'    =>esc_html__( 'Promo Box Layout 3', 'sportshub' ),
                     'promo_box_layout4'    =>esc_html__( 'Promo Box Layout 4', 'sportshub' ),
                  ],
         ]
      );
      $this->add_control(
         'promo_box_image',[
         'label' => __( '1st Promo Box Image', 'sportshub' ),
      ...
      $this->add_control(
         'promo_box_title',[
            'label' => __( '1st Title Box', 'sportshub' ),
            'type' => Controls_Manager::TEXT,
            'label_block'   => true,
            'default' => __( 'Title' , 'sportshub' ),
         ]
      );
      $this->add_control(
         'promo_box_link',[
            'label' => __( '1st Link URL', 'sportshub' ),
      ...
      $this->add_control(
         'promo_box_image_second',[
            'label' => __( '2nd Promo Box Image', 'sportshub' ),
            'type' => Controls_Manager::MEDIA,
            'label_block' => true,
         ]
      );
      $this->add_control(
         'promo_box_title_second',[
            'label' => __( '2nd Title Box', 'sportshub' ),
            'type' => Controls_Manager::TEXT,
            'default' => __( 'Title' , 'sportshub' ),
         ]
      );
      $this->add_control(
         'promo_box_link_second',[
            'label' => __( '2nd Link URL', 'sportshub' ),
            'type' => Controls_Manager::URL,
            'default' => [
                  'url' => '',
                  'is_external' => '',
      ...
      $this->add_control(
         'promo_box_image_third',[
            'label' => __( '3rd Promo Box Image', 'sportshub' ),
            'type' => Controls_Manager::MEDIA,
            'label_block' => true,
         ]
      );
      $this->add_control(
         'promo_box_title_third',[
            'label' => __( '3rd Title Box', 'sportshub' ),
            'type' => Controls_Manager::TEXT,
            'default' => __( 'Title' , 'sportshub' ),
         ]
      );
      $this->add_control(
         'promo_box_link_third',[
            'name' => '3rd Image Box Link',
            'label' => __( '3rd Link URL', 'sportshub' ),
            'type' => Controls_Manager::URL,
            'default' => [
                  'url' => '',
                  'is_external' => '',
   ...
   protected function render( ) {
      ...
      $promo_box_layout = $settings['promo_box_layout'];
      $promo_box_link =$settings['promo_box_link'];
      $promo_box_image = $settings['promo_box_image'];
      $promo_box_title = $settings['promo_box_title'];
      $promo_box_image_second = $settings['promo_box_image_second'];
      $promo_box_title_second = $settings['promo_box_title_second'];
      $promo_box_link_second = $settings['promo_box_link_second'];
      $promo_box_image_third = $settings['promo_box_image_third'];
      $promo_box_link_third = $settings['promo_box_link_third'];
      $promo_box_title_third = $settings['promo_box_title_third'];
      ...
      <?php if($promo_box_layout == 'promo_box_layout1'){?>
         <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
               
                  <a href="<?php echo esc_url($promo_box_link['url']); ?>">
                     <div class="themelazer_promo " style="background-image: url('<?php echo esc_url($promo_box_image['url']); ?>')">
                        <h2><?php echo esc_html($promo_box_title); ?></h2>
                     </div>
                  </a>
               </div>
            </div>
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
                  <a href="<?php echo esc_url($promo_box_link_second['url']); ?>">
                     <div class="themelazer_promo" style="background-image: url('<?php echo esc_url($promo_box_image_second['url']); ?>')">
                        <h2><?php echo esc_html($promo_box_title_second); ?></h2>
                     </div>
                  </a>
               </div>
            </div>
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
               <a href="<?php echo esc_url($promo_box_link_third['url']); ?>">
                     <div class="themelazer_promo " style="background-image: url('<?php echo esc_url($promo_box_image_third['url']); ?>')">
                        <h2><?php echo esc_html($promo_box_title_third); ?></h2>
                     </div>
                  </a>
               </div>
            </div>
         </div>
      <?php }elseif($promo_box_layout == 'promo_box_layout2'){?>
         <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
                  
                  <a href="<?php echo esc_url($promo_box_link['url']); ?>">
                     <div class="themelazer_promo_layout2 " style="background-image: url('<?php echo esc_url($promo_box_image['url']); ?>')">
                           <h2><?php echo esc_html($promo_box_title); ?></h2>
                     </div>
                  </a>
               </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
                  <a href="<?php echo esc_url($promo_box_link_second['url']); ?>">
                     <div class="themelazer_promo_layout2" style="background-image: url('<?php echo esc_url($promo_box_image_second['url']); ?>')">
                        <h2><?php echo esc_html($promo_box_title_second); ?></h2>
                     </div>
                  </a>
               </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
                  <a href="<?php echo esc_url($promo_box_link_third['url']); ?>">
                        <div class="themelazer_promo_layout2 " style="background-image: url('<?php echo esc_url($promo_box_image_third['url']); ?>')">
                           <h2><?php echo esc_html($promo_box_title_third); ?></h2>
                     </div>
                  </a>
               </div>
      ...
      <?php }elseif($promo_box_layout == 'promo_box_layout3'){?>
         <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
                  <a href="<?php echo esc_url($promo_box_link['url']); ?>">
                     <div class="themelazer_promo_layout3 " style="background-image: url('<?php echo esc_url($promo_box_image['url']); ?>')">
                           <h2><?php echo esc_html($promo_box_title); ?></h2>
                     </div>
                  </a>
               </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
                  <a href="<?php echo esc_url($promo_box_link_second['url']); ?>">
                     <div class="themelazer_promo_layout3" style="background-image: url('<?php echo esc_url($promo_box_image_second['url']); ?>')">
                        <h2><?php echo esc_html($promo_box_title_second); ?></h2>
                     </div>
                  </a>
               </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
                  <a href="<?php echo esc_url($promo_box_link_third['url']); ?>">
                        <div class="themelazer_promo_layout3 " style="background-image: url('<?php echo esc_url($promo_box_image_third['url']); ?>')">
                           <h2><?php echo esc_html($promo_box_title_third); ?></h2>
                     </div>
                  </a>
               </div>
      ...
      <?php }elseif($promo_box_layout == 'promo_box_layout4'){?>
         <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
                  
                  <a href="<?php echo esc_url($promo_box_link['url']); ?>">
                     <div class="themelazer_promo_layout4 " style="background-image: url('<?php echo esc_url($promo_box_image['url']); ?>')">
                           <h2><?php echo esc_html($promo_box_title); ?></h2>
                     </div>
                  </a>
               </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
                  <a href="<?php echo esc_url($promo_box_link_second['url']); ?>">
                     <div class="themelazer_promo_layout4" style="background-image: url('<?php echo esc_url($promo_box_image_second['url']); ?>')">
                        <h2><?php echo esc_html($promo_box_title_second); ?></h2>
                     </div>
                  </a>
               </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="themelazer_promo_wrapper">
                  <a href="<?php echo esc_url($promo_box_link_third['url']); ?>">
                        <div class="themelazer_promo_layout4 " style="background-image: url('<?php echo esc_url($promo_box_image_third['url']); ?>')">
                           <h2><?php echo esc_html($promo_box_title_third); ?></h2>
                     </div>
                  </a>
               </div>
