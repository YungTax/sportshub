...
class sportshub_slider_center extends Widget_Base {
    public $base;
    public function get_name() {
        return 'sportshub-slider-center';
    }
    public function get_title() {
        return esc_html__( 'Slider Center', 'sportshub' );
    }
    ...
    protected function render( ) { 
        ...
        <?php if ( $query->have_posts() ) : 
            ...
            <div class="themelazer_perosnal_blog_slider_wrapper">     
                <?php 
                    if($show_arrows =='yes')
                        echo '<div class="themelazer-slider themelazer_loading_before_slick_initialized" data-arrows="true" data-play="true" data-autospeed="8000" data-loop="true" data-dots="false" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="1" data-lg-items="1" data-xl-items="1">';
                    else 
                        echo '<div class="themelazer-slider themelazer_loading_before_slick_initialized" data-arrows="false" data-play="true" data-autospeed="8000" data-loop="true" data-dots="false" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="1" data-lg-items="1" data-xl-items="1">';
                ?>
                    <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                        <div class="themelazer-slider-item">
                            <div class="themelazer_perosnal_blog_slider_content center">
