...
class sportshub_slider extends Widget_Base {

    public $base;
    public function get_name() {
        return 'sportshub-slider';
    }
    public function get_title() {
        return esc_html__( 'Slider', 'sportshub' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'slider_post_layout',
            [
                'label'     =>esc_html__( 'Slider Post Layout', 'sportshub' ),
                'description' =>esc_html__( 'Select Post Layout Per Page.', 'sportshub'),
                'type'      =>Controls_Manager::SELECT,
                'default'   => 'slider_post_layout1',
                'options'   => [
                        'slider_post_layout1'    =>esc_html__( 'Slider Post Layout 1', 'sportshub' ),
                        'slider_post_layout2'    =>esc_html__( 'Slider Post Layout 2', 'sportshub' ),
                ],
            ]
        );
    ...
    protected function render( ) { 
        ...
        $slider_post_layout = $settings['slider_post_layout'];
        ...
        <?php if ( $query->have_posts() ) : 
            ...
            <?php if($slider_post_layout == 'slider_post_layout1'){?>
                <div class="themelazer_perosnal_blog_slider_wrapper">     
                        <?php   
                            if($show_arrows =='yes')
                                echo '<div class="themelazer-slider-center themelazer_loading_before_slick_initialized" data-arrows="true" data-play="true" data-autospeed="8000" data-loop="true" data-dots="true" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="1" data-lg-items="2" data-xl-items="3">';
                            else 
                                echo '<div class="themelazer-slider-center themelazer_loading_before_slick_initialized" data-arrows="false" data-play="true" data-autospeed="8000" data-loop="true" data-dots="true" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="1" data-lg-items="2" data-xl-items="3">';
                        ?>          
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <div class="themelazer-slider-item">
                                <div class="themelazer_perosnal_blog_slider_content">
                                    <?php $feature_img_main = get_post_thumbnail_id();
                                        $feature_img_main_bg = wp_get_attachment_image_src( $feature_img_main, 'sportshub_slider', true );
                                        if($feature_img_main){?>
            ...
            <?php }elseif($slider_post_layout == 'slider_post_layout2'){?>   
                <div class="themelazer_perosnal_blog_slider_wrapper">     
                        <?php   
                            if($show_arrows =='yes')
                                echo '<div class="themelazer-slider-center themelazer_loading_before_slick_initialized" data-arrows="true" data-play="true" data-autospeed="8000" data-loop="true" data-dots="true" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="1" data-lg-items="2" data-xl-items="3">';
                        ...
                        <?php $i = 0; while ($query->have_posts()) : $query->the_post(); $i++;?>
                            <div class="themelazer-slider-item">
                                <div class="themelazer_perosnal_blog_slider_content">
                                    ...
                                    <a href="<?php the_permalink();?>" class="themelazer_item_link_lay_two" <?php  echo 'style="background:'.$title_bg_Color.';"' ?>tabindex="-1"></a>
                                    <div class="slide_text_box_lay_two">
                                        <?php if(get_theme_mod('disable_post_category') !=1){
                                                if( $show_cat =='yes'){
                                                    $categories = get_the_category(get_the_ID());          
                                                    if ($categories) {
