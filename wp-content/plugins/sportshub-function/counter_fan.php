...
if ( ! function_exists( 'sportshub_counter_num' ) ) {
	function sportshub_counter_num( $number ) {
...
if ( ! class_exists( 'sportshub_themelazer_social_fan' ) ) {
	class sportshub_themelazer_social_fan {
		...
		static function themelazer_get_social_counter( $social = '', $option = array() ) {

			$cache_data_name = 'sportshub_social_fan_' . $social;
