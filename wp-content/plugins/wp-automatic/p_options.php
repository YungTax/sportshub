	...
	if (! empty ( $_POST ['wp_automatic_license'] ) &&  ( wp_automatic_trim( $licenseactive ) == '' || ( $licenseactive_purchase != $_POST['wp_automatic_license'] ) ) ) {
		...
		if (isset ( $resarr->message )) {
			...
			if (isset ( $resarr->error )){
				...
				update_option ( 'wp_automatic_license_active', '' );
				$licenseactive = '';
...
<script type="text/javascript" src="<?php   echo $dir; ?>js/main.js?ver=5.0.3"></script>
						...
						<div style="min-height: 1px;" class="meta-box-sortables ui-sortable" id="normal-sortables">
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<!-- Admitad affiliate link e.g: https://wextap.com/g/1e8d1144944ff82e4b4e16525dc3e8/ -->
									<div class="field f_100 ">
										<label> Admitad affiliate link</label> <input value="<?php   echo get_option( 'wp_automatic_ali_admitad' ) ?>" name="wp_automatic_ali_admitad" type="text">
										<div class="description">
											Apply and add your link for affilite earnings from AliExpress. the plugin will automatically build the affiliate link for you
											<br><br>*Apply <a href="https://store.admitad.com/en/webmaster/websites/2664976/offers/6115" target="_blank">here</a>
											<br><br>*Check <a href="https://valvepress.com/how-to-generate-aliexpress-affiliate-links-automatically-on-wordpress/" target="_blank">this tutorial</a> on how to get it
											<br><br>*e.g: https://wextap.com/g/1e8d1144944ff82e4b4e16525dc3e8/
										</div>
									</div>
							...
							<!-- Bing news serach API key -->
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								<h2 class="hndle">
									<img class="wp_automatic_box_icon" src="<?php   echo plugins_url('images/bing.png',__FILE__)?>"><span> Bing news settings</span>
								</h2>
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									<!--start container-->
									<div id="field285-container" class="field f_100 ">
										<label for="field285"> Bing news search API key? </label> <input value="<?php   echo get_option( 'wp_automatic_bing_key' ) ?>" name="wp_automatic_bing_key" type="text">

										<div class="description">
											Visit <a target="_blank" href="https://valvepress.com/how-to-create-a-bing-news-search-api-key/">This tutorial</a> for how to create an API key. 
										</div>
							...
							<!-- SpinRewriter email and apikey -->
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								<h2 class="hndle">
									<img class="wp_automatic_box_icon" src="<?php   echo plugins_url('images/spinrewriter.png',__FILE__)?>"><span> SpinRewriter settings</span>
								</h2>
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									<!--start container-->
									<div id="field285-container" class="field f_100 ">
										<label for="field285"> <a href="http://www.spinrewriter.com/?ref=11ade" target="_blank" >SpinRewriter</a> email? </label> <input value="<?php   echo get_option( 'wp_automatic_spinrewriter_email' ) ?>" name="wp_automatic_spinrewriter_email" type="text">
									</div>

									<div id="field285-container" class="field f_100 ">
										<label for="field285"> SpinRewriter API key? </label> <input value="<?php   echo get_option( 'wp_automatic_spinrewriter_key' ) ?>" name="wp_automatic_spinrewriter_key" type="text">
									</div>
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<div class="field f_100">
											<div class="option clearfix">
												<input name="wp_automatic_options[]" <?php   echo cchecked('wp_automatic_options', 'OPT_EBAY_PRICE')  ?> value="OPT_EBAY_PRICE" type="checkbox"> <span class="option-title">Check & update eBay products prices (daily)</span>

												<div class="field f_100">
													
													<div class="option clearfix">
														<input name="wp_automatic_options[]" <?php   echo cchecked('wp_automatic_options', 'OPT_EBAY_DELETE')  ?> value="OPT_EBAY_DELETE" type="checkbox"> <span class="option-title"> Delete not found products (no more on eBay)</span>
													</div>
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<!-- video width defaults to 500 -->
									<div class="field f_100 ">
										<label>Video width</label> <input value="<?php   echo get_option( 'wp_automatic_fb_vw' , 500 ) ?>" name="wp_automatic_fb_vw" type="text">
									</div>
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								<h2 class="hndle">
									<img class="wp_automatic_box_icon" src="<?php   echo plugins_url('images/rd.png',__FILE__)?>"><span> Reddit settings</span>
								</h2>
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									<!--start container-->
									<div id="field285-container" class="field f_100 ">
										<label for="field285"> Reddit session cookie value </label> <input value="<?php   echo get_option( 'wp_automatic_reddit_sess' ) ?>" name="wp_automatic_reddit_sess" type="text">
										<div class="description">
											Check <a href="https://valvepress.com/how-to-get-reddit-session-cookie-to-auto-post-from-reddit-to-wordpress-complete-guide/" target="_blank">this tutorial</a> on how to get it
										</div>
									</div>
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<div class="field f_100 ">
										<label><a href="https://www.apify.com?fpr=htjt0">APIFY</a> API token</label> 
										
										<textarea name="wp_automatic_apify_key"><?php   echo get_option( 'wp_automatic_apify_key' ) ?></textarea>
												
										<div class="description">
											*Check <a href="http://valvepress.com/how-to-get-apify-token-to-import-from-sites-that-depends-on-javascript/" target="_blank">this tutorial</a> on how to get your API token<br><br>*You can add multiple keys (one per line) for the plugin to rotate between them
										</div>
									</div>
							...
							<!-- OpenRouter API key -->
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								<h2 class="hndle"> <img class="wp_automatic_box_icon" src="<?php   echo plugins_url('images/openrouter.ico',__FILE__)?>"><span> OpenRouter API Key</span> </h2>
								<div class="inside TTWForm main" style="padding-bottom: 14px"> <!--start container-->
									<div class="field f_100 ">
										<label>OpenRouter API Key*</label> <textarea name="wp_automatic_openrouter_key"><?php   echo get_option( 'wp_automatic_openrouter_key' ) ?></textarea>
										<div class="description">
											*Check <a href="https://valvepress.com/how-to-generate-an-openrouter-api-key-for-wordpress-automatic-plugin/" target="_blank">this tutorial</a> on how to get your API token
											<br><br>*You can add a single key or a list of keys(one per line) for the plugin to rotate between them.
										</div>
									</div>
									...
									<!-- default model -->
									<div class="field f_100 ">
										<label>Default model (optional)</label> <input value="<?php   echo get_option( 'wp_automatic_openrouter_model', 'meta-llama/llama-3-8b-instruct:free' ) ?>" name="wp_automatic_openrouter_model" type="text">
										<div class="description">
											*The default model to use if no model is specified in the campaign. <br><br>*Check <a href="https://openrouter.ai/models" target="_blank">OpenRouter models</a> for available models. e.g: google/gemini<br><br>*You can use free models like "meta-llama/llama-3-8b-instruct:free"<br><br>*If left empty, the plugin will use the free model "meta-llama/llama-3-8b-instruct:free"<br><br>*OpenRouter free models are limited to 200 daily requests per API Key 
										</div>
									</div>
