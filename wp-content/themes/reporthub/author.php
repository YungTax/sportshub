      ...
      <div class="row"> <!-- Bootstrap row to create a grid layout -->
         <div class="col-md-8 themelazer_content"> <!-- Main content area taking up 8 out of 12 columns on medium and larger screens -->
                     ...
                     <div class="author_description">
                        ...
                        <div class="author_bio">
                           ...
                           <p class="author_post_count">
                              <?php echo esc_html_e('Posts made: ', 'reporthub') . count_user_posts(get_the_author_meta('ID')); // Display count of posts made by the author ?>
                           </p>
                        </div>
                        <div class="themelazer-author-social-links"> <!-- Author social links section -->
                           <div class="themelazer-social-links-items">
                              <div class="themelazer-social-links-item">
                                 <?php 
                                 if (function_exists('reporthub_author_contact_icons')) { 
                                    reporthub_author_contact_icons(get_the_ID()); // Display author's social contact icons if the function exists
                                 } 
                                 ?>
                              </div>
                           </div>
            ...
            <h3 class="themlazer_author_post_title">
               <?php echo esc_html_e('Latest articles by ', 'reporthub') . the_author_meta('display_name'); // Display 'Latest articles by' followed by the author's display name ?>
            </h3>
