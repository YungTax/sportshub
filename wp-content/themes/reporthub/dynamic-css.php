<?php
    //Menu
    $reporthub_menu_font_family = get_theme_mod('reporthub_menu_font_family', 'Jost');
    $reporthub_menu_font_size = get_theme_mod('reporthub_menu_font_size', '14px');
    $reporthub_menu_font_weight = get_theme_mod('reporthub_menu_font_weight', '500');
    $reporthub_menu_transform = get_theme_mod('reporthub_menu_transform', 'uppercase');
    //Sub Menu
    $reporthub_sub_menu_font_size = get_theme_mod('reporthub_sub_menu_font_size', '13px');
    $reporthub_sub_menu_font_weight = get_theme_mod('reporthub_sub_menu_font_weight', '600');
    $reporthub_sub_menu_transform = get_theme_mod('reporthub_sub_menu_transform', 'uppercase');
    //Paragraph
    $reporthub_p_font_family = get_theme_mod('reporthub_p_font_family', 'Jost');
    $reporthub_p_font_size = get_theme_mod('reporthub_p_font_size', '18px');
    $reporthub_p_font_weight = get_theme_mod('reporthub_p_font_weight', '500');
    //Category
    $reporthub_category_font_family = get_theme_mod('reporthub_category_font_family', 'Jost');
    $reporthub_category_font_size = get_theme_mod('reporthub_category_font_size', '12px');
    $reporthub_category_font_weight = get_theme_mod('reporthub_category_font_weight', '600');
    //Title
    $reporthub_title_font_family = get_theme_mod('reporthub_title_font_family', 'Playfair Display ');
    $reporthub_title_font_weight = get_theme_mod('reporthub_title_font_weight', '600');
    $reporthub_title_transform = get_theme_mod('reporthub_title_transform', 'capitalize');    
    // Letter Spacing
...
body, p {
    ...
    font-size: <?php echo esc_attr($reporthub_p_font_size); ?>;
    font-family: <?php echo esc_attr($reporthub_p_font_family); ?>, sans-serif !important;
    font-weight: <?php echo esc_attr($reporthub_p_font_weight); ?> !important;
}
...
.comments-area h3#reply-title {
    font-family: <?php echo esc_attr($reporthub_p_font_family); ?>, sans-serif;
}
...
#themelazer_search_wrapper .category_header_search .themelazer_post_categories_search_form a {
    font-family: <?php echo esc_attr($reporthub_category_font_family); ?> !important;
    font-weight: <?php echo esc_attr($reporthub_category_font_weight); ?> !important;
}

/* Navigation Styles */
.slicknav_nav a {
    font-size: <?php echo esc_attr($reporthub_menu_font_size); ?> !important;
    font-family: <?php echo esc_attr($reporthub_menu_font_family); ?>, sans-serif !important;
    letter-spacing: <?php echo esc_attr($letter_spacing_menu); ?> !important;
    text-transform: <?php echo esc_attr($reporthub_menu_transform); ?> !important;
    font-weight: <?php echo esc_attr($reporthub_menu_font_weight); ?> !important;
}

/* Scroll To Top Styles */
.scroll-totop {
    font-family: <?php echo esc_attr($reporthub_title_font_family); ?> !important;
    <?php if($reporthub_title_transform) { echo 'text-transform:'.$reporthub_title_transform.' !important;'; } ?>
}
...
<?php }// menu font?>
.themelazer-navigation ul li a{font-size: <?php echo esc_attr($reporthub_menu_font_size);?> !important; font-family: <?php echo esc_attr($reporthub_menu_font_family);?>,sans-serif !important;<?php echo 'letter-spacing: '.$letter_spacing_menu.' !important;';?> <?php echo 'text-transform: '.esc_attr($reporthub_menu_transform).' !important;';?>}
.themelazer-navigation .menu li > a{font-size:<?php echo esc_attr($reporthub_menu_font_size);?>!important;font-family: <?php echo esc_attr($reporthub_menu_font_family);?> ,sans-serif !important;<?php echo 'letter-spacing: '.$letter_spacing_menu.' !important;';?> <?php echo 'text-transform: '.esc_attr($reporthub_menu_transform).' !important;';?> }

<?php // submenu font?>
.themelazer-navigation .menu > li li a{ <?php echo 'letter-spacing: '.$letter_spacing_sub_menu.' !important;';?> <?php echo 'text-transform: '.esc_attr($reporthub_sub_menu_transform).' !important;';?> <?php echo 'font-size:'.esc_attr($reporthub_sub_menu_font_size).' !important;';?> <?php echo 'font-weight:'.esc_attr($reporthub_sub_menu_font_weight).' !important;';?>}
...
.themelazer_post_categories a{font-family:<?php echo esc_attr($reporthub_category_font_family);?> !important; font-size:<?php echo esc_attr($reporthub_category_font_size);?> !important; font-weight:<?php echo esc_attr($reporthub_category_font_weight);?> !important;}
...
.widget_categories ul li{font-family:<?php echo esc_attr($reporthub_category_font_family);?> !important;  <?php if($reporthub_title_transform){echo 'text-transform:'.$reporthub_title_transform.' !important;';}?> }
.themelazer-pagination .page-numbers.current{background: <?php echo esc_attr($color);?> !important;}
.postnav_left span, .postnav_right span.lz_post_nav_right{<?php if($reporthub_title_transform){echo 'text-transform:'.$reporthub_title_transform.' !important;';}?>}
...
<?php // headding font?>
.comments-area li .comment-content.comment .comment-author-name a{font-family:<?php echo esc_attr($reporthub_title_font_family);?> !important;
 <?php if($reporthub_title_transform){echo 'text-transform:'.$reporthub_title_transform.' !important;';}?>
}
h1, h2, h3, h4, h5, h6 {font-family:<?php echo esc_attr($reporthub_title_font_family);?> !important;}
h1, h2, h3, h4, h5, h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, .postnav #prepost, .postnav  #nextpost, .bbp-forum-title, 
{font-weight: <?php echo esc_attr($reporthub_title_font_weight);?> !important; <?php if($reporthub_title_transform){echo 'text-transform:'.$reporthub_title_transform.' !important;';}?> <?php if(get_theme_mod('letter_spacing_heading')){echo 'letter-spacing: '.esc_attr(get_theme_mod('letter_spacing_heading','-0.03em')).' !important;';}?>}
