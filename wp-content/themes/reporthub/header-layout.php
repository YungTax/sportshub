      ...
      <div class="themelazer_middle_header white_bg">
               ...
               <div class="col-md-12">
                  <div class="themelazer_promomenu_wrapper">
                     ...
                     <div class="themelazer_mobile_logo">
                        ...
                        <?php else: ?>
                        <img src="<?php echo esc_url(get_template_directory_uri().'/img/reporthub_white.png'); ?>" alt="<?php bloginfo('description'); ?>" />
                        <?php endif; ?></a>
                     </div>
         ...
         <div id="themelazer_search_wrapper">
            ...
            <form role="search" class="form-search" method="get" id="s" action="<?php echo esc_url( home_url( '/' ) ); ?>" >
               <input spellcheck="false" autocomplete="off" type="text" value="" name="s" placeholder="<?php esc_attr_e('Search...', 'reporthub'); ?>" />
            </form>
