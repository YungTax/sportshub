<?php
    //Theme style
    add_action( 'wp_enqueue_scripts', 'reporthub_load_css' );
    function reporthub_load_css() {
        ...
        wp_enqueue_style( 'reporthub_style', get_template_directory_uri().'/style.css', false, '1.0' );
        wp_enqueue_style( 'reporthub_style_min', get_template_directory_uri().'/css/main.min.css',true,'1.0');
        wp_add_inline_style( 'reporthub_style', reporthub_generate_dynamic_css() );
    }
    if ( !function_exists( 'reporthub_generate_dynamic_css' ) ){
        function reporthub_generate_dynamic_css() {
    ...
    //Theme scripts
    function reporthub_enqueue_script() {
        ...
        wp_enqueue_script( 'reporthub-main', get_template_directory_uri().'/js/main.js', array('jquery'), '1.0', true );
    }
    add_action( 'wp_enqueue_scripts', 'reporthub_enqueue_script' );
?>