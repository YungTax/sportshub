...
$( window ).on( 'elementor/frontend/init', function() {
    elementorFrontend.hooks.addAction( 'frontend/element_ready/reporthub-carousel.default', themelazer_slider_option ); 
    elementorFrontend.hooks.addAction( 'frontend/element_ready/reporthub-carousel-z.default', themelazer_slider_option);
    elementorFrontend.hooks.addAction( 'frontend/element_ready/reporthub-slider.default', themelazer_slider_option );
    elementorFrontend.hooks.addAction( 'frontend/element_ready/reporthub-slider-center.default', themelazer_slider_option );
    elementorFrontend.hooks.addAction( 'frontend/element_ready/reporthub-feature-slider.default', themelazer_slider_option );
    elementorFrontend.hooks.addAction( 'frontend/element_ready/reporthub-feature-slider-style-two.default',themelazer_slider_option);
    elementorFrontend.hooks.addAction( 'frontend/element_ready/reporthub-animation-text-circle.default', themelazer_slider_option );
    elementorFrontend.hooks.addAction( 'frontend/element_ready/reporthub-marsonry-post.default', WidgetMasonryHandler );
  });
})( jQuery );