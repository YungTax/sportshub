<div class="themelazer_full_post">
    ...
    // Get the URL of the featured image in the 'reporthub_large_slider_image' size
    $feature_img_main_bg = wp_get_attachment_image_src($feature_img_main, 'reporthub_large_slider_image', true);
