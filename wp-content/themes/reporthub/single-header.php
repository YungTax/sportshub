<div class="single_header_wrapper">
         ...
         if ($categories) : ?>
            <div class="themelazer_post_categories">
               <?php foreach ($categories as $tag) :
                  ...
                  $title_reactions = get_term_meta($tag->term_id, "reporthub_cat_reactions", true);
                  if (!$title_reactions) : ?>
   ...
   <?php echo reporthub_singlepost_meta(get_the_ID()); ?>
</div>
         ...
         if ($image_gallery_val !== "") :
            ...
            if (isset($image_gallery_array) && count($image_gallery_array) != 0) :
               foreach ($image_gallery_array as $gimg_id) :
                     $the_image = wp_get_attachment_image_src($gimg_id, 'reporthub_justify_feature');
      ...
      <div class="themelazer_single_feature">
         <div class="themelazer_full_post">
            <?php if (get_post_meta($post->ID, 'quote_post_title', true)) : ?>
               <?php $slider_large_image_header = wp_get_attachment_image_src($slider_large_thumb_id, 'reporthub_justify_feature', true); ?>
   ...
   <div class="themelazer_single_feature">
      ...
      if ($audio_embed != "") :
         ...
         if (has_post_thumbnail()) {
            the_post_thumbnail('reporthub_justify_feature');
         }
