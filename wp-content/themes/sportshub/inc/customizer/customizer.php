...
function sportshub_register_theme_customizer( $sportshub_customize ) {
	...
	$sportshub_customize->add_control(
	    new sportshub_control_image_select (
	        ...
	        'footer_layout_design',
	        array(
	            'label'      	=> esc_html__( 'Footer Layout (Footer menu and logo)', 'sportshub' ),
	            'description'	=> esc_html__('Select Footer style.', 'sportshub'),
	            'section'		=> 'sportshub_general_setting',
	...
	//         'category_layout_design',
	//         array(
	//             'label'      	=> esc_html__( 'Category Style', 'sportshub' ),
	//             'description'	=> esc_html__('Select category style.', 'sportshub'),
	//             'section'		=> 'sportshub_general_setting',
